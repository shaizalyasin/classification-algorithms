...
class DecisionTreeDecisionOutcomeAbove(DecisionTreeDecisionOutcome):
    """
    A class representing the outcome of a decision with all values above a certain threshold being part of the outcome
    (e.g. If all values above 25 are part of this specific outcome)
    """
    ...
    def __eq__(self, decisionOutcome: object) -> bool:
        ...
        """
        if not isinstance(decisionOutcome, DecisionTreeDecisionOutcomeAbove):
            return False
